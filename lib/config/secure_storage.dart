...
class SecureStorage {
  ...
  static const _keySessionId = 'plane_session_id';
  static const _keyAuthMethod = 'plane_auth_method'; // 'api_key' or 'session'

  // API Key (legacy / advanced)
  ...
  // Auth method
  static Future<void> saveAuthMethod(String method) =>
      _storage.write(key: _keyAuthMethod, value: method);

  static Future<String?> getAuthMethod() => _storage.read(key: _keyAuthMethod);
